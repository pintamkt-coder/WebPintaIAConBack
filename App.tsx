...
const ProjectCard: React.FC<{ project: Project; onOpenProject: (p: Project) => void }> = ({ project, onOpenProject }) => (
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent flex flex-col justify-end p-8 md:p-10 z-10">
      <span className="text-[#EBE300] text-xs md:text-sm font-black uppercase mb-1 tracking-[0.2em] drop-shadow-md">{project.category}</span>
      <h3 className="text-white text-2xl md:text-3xl lg:text-4xl font-[900] uppercase tracking-tighter leading-[0.9] mb-6 drop-shadow-lg">{project.title}</h3>
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ['home', 'about', 'works', 'extension', 'services', 'clients', 'contact'].forEach(id => {
    ...
    <div className="min-h-screen bg-[#FDFCE6] selection:bg-[#EBE300] selection:text-black">
      ...
      <section id="home" className="relative min-h-screen flex flex-col items-center justify-center bg-[#1A1A1A] overflow-hidden px-4">
        <div className="z-10 text-center max-w-6xl mx-auto">
          <div className="flex justify-center mb-12"><img src="https://img.icons8.com/ios-filled/100/EBE300/bee.png" alt="Abeja" className="w-16 h-16 md:w-24 md:h-24" /></div>
...
">
  ...
  <span className="text-[#EBE300]">
    {"NOSOTROS TRANSFORMAMOS\nIDEAS EN NEGOCIOS."}
          ...
          <a href="#contact" className="inline-flex items-center gap-4 px-12 py-6 bg-[#EBE300] text-black font-[900] text-xl uppercase tracking-tighter hover:bg-white transition-all rounded-full shadow-lg">Descubrir <ArrowRight size={24} /></a>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="group">
              ...
              <div className="bg-white p-10 border-4 border-black rounded-[3rem] shadow-xl hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] transition-all duration-500">
                <p className="text-lg md:text-xl font-bold leading-relaxed text-gray-800 italic">"En pinta contamos con un equipo ágil, flexible y estrategico."</p>
              </div>
            </div>
            <div className="relative group">
              ...
              <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=800" className="relative rounded-[3rem] border-4 border-black w-full aspect-square object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 shadow-2xl z-10" alt="Equipo Pinta MKT" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-[900] uppercase tracking-tighter leading-none mb-6">
              ¿BUSCANDO UNA <span className="text-[#EBE300]">EXTENSIÓN DE TU</span><br/>EQUIPO?
            </h2>
            <p className="text-sm md:text-base font-black text-white/50 uppercase tracking-[0.2em] max-w-2xl mx-auto">
              OLVÍDATE DEL OUTSOURCING TRADICIONAL. SOMOS PINTA MKT, TU ALIADO ESTRATÉGICO DIARIO.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6">
              {[
                ...
                <div key={i} className="bg-[#141414] border border-white/5 p-8 rounded-[2rem] flex flex-col justify-between hover:bg-white/5 transition-colors group">
                  ...
                  <h3 className="font-black text-lg md:text-xl uppercase tracking-tighter leading-none">{card.label}</h3>
                </div>
              ))}
            </div>
            ...
            <div className="bg-[#EBE300] text-black rounded-[3rem] p-10 md:p-16 flex flex-col justify-center relative overflow-hidden shadow-[0_40px_80px_-20px_rgba(235,227,0,0.3)]">
              <div className="mb-10 relative z-10">
                <div className="mb-8">
                  <span className="inline-block px-5 py-2 bg-black text-[#EBE300] font-black text-[10px] uppercase tracking-widest rounded-full">NUESTRO VALOR</span>
                </div>
                ...
                <a href="#contact" className="inline-flex items-center gap-4 px-10 py-5 bg-black text-white font-black text-base uppercase tracking-widest rounded-full hover:scale-105 transition-transform group shadow-xl">
                  Saber más <ArrowRight size={20} className="group-hover:translate-x-2 transition-transform" />
                </a>
              </div>
              {/* Graphic background element */}
              <div className="absolute -bottom-10 -right-10 opacity-10 rotate-12">
                <img src="https://img.icons8.com/ios-filled/200/000000/bee.png" alt="" className="w-64 h-64" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {SERVICES.map((service) => (
              <div key={service.id} className="bg-white border-[6px] border-black rounded-[3.5rem] p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col h-full transition-all hover:-translate-y-3 group">
          ...
          <div className="flex animate-scroll-right gap-20 md:gap-32 items-center">
            {[...CLIENTS_LIST, ...CLIENTS_LIST].map((client, i) => (
              <div key={i} className="flex-shrink-0 flex items-center justify-center h-16 w-48 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all">
                <span className="text-white/30 font-black uppercase text-xl">{client.name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-start">
            <div className="w-full lg:w-[55%]">
              <h2 className="text-[12vw] lg:text-[8rem] font-[900] uppercase tracking-tighter leading-[0.8] mb-12 text-black">HABLEMOS</h2>
              <p className="text-2xl font-[900] text-gray-500 uppercase tracking-[0.6px]  mb-16 italic drop-shadow-sm ">¿ESTAS LISTO PARA TRANSFORMAR TU MARCA?
              Conectemos y hagamos crecer tu colmena</p>
              ...
              <div className="flex flex-col gap-8">
                ...
                <a href="https://wa.me/5492617007256" target="_blank" className="flex items-center gap-6 group w-fit pt-2">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 mb-1">WhatsApp Directo</span>
                    <span className="font-[900] text-xl md:text-2xl lg:text-3xl uppercase tracking-tighter text-black">+54 9 261 700 7256</span>
                  </div>
                </a>
              </div>
            </div>
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[300] bg-black overflow-y-auto animate-in fade-in duration-500">
          <div className="sticky top-0 z-[310] flex justify-between items-center p-6 bg-black/80 backdrop-blur-lg">
            <button onClick={() => setSelectedProject(null)} className="hover:opacity-80 transition-opacity"><LogoText className="w-32 text-[#EBE300]" /></button>
            <button onClick={() => setSelectedProject(null)} className="p-3 bg-[#EBE300] text-black rounded-full hover:scale-110 transition-transform shadow-lg"><X size={20} /></button>
          </div>
          <div className="container mx-auto max-w-7xl px-4 py-12 md:py-20">
            <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-start">
              <div>
                ...
                <p className="text-lg md:text-xl text-white/70 font-bold mb-12">{selectedProject.description}</p>
              ...
              <img src={selectedProject.image} alt={selectedProject.title} className="w-full aspect-[4/3] object-cover rounded-[2rem] border-2 border-white/20 shadow-2xl" />
            </div>
          </div>
        </div>
      )}
